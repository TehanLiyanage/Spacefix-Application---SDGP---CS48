...
//         <h2 className="text-lg sm:text-xl md:text-2xl font-medium text-emerald-600 flex items-center">
//           <BellRing className="mr-2 sm:mr-3 h-5 w-5 sm:h-6 sm:w-6 text-emerald-600" />
//           Announcements Management
//         </h2>
//         <button
//           onClick={handleAddNew}
//           className="bg-emerald-500 hover:bg-emerald-600 text-white px-3 sm:px-4 py-1.5 sm:py-2 rounded-md flex items-center shadow-md transition-colors text-sm sm:text-base w-full sm:w-auto justify-center"
//         >
...
//       {/* Form */}
//       {showForm && (
//         <div className="bg-white p-3 sm:p-4 md:p-6 rounded-md shadow-md mb-4 sm:mb-6 border border-gray-200">
//           <h3 className="text-base sm:text-lg font-medium mb-3 sm:mb-4 text-emerald-600">
...
//                 className="w-full p-1.5 sm:p-2 text-sm sm:text-base border border-gray-300 rounded-md focus:ring-emerald-500 focus:border-emerald-500"
//                 required
//               />
//             </div>
...
//                 className="px-3 sm:px-4 py-1.5 sm:py-2 bg-gray-200 text-gray-800 rounded-md hover:bg-gray-300 transition-colors text-sm sm:text-base"
//               >
//                 Cancel
//               </button>
//               <button
//                 type="submit"
//                 className="px-3 sm:px-4 py-1.5 sm:py-2 bg-emerald-500 text-white rounded-md hover:bg-emerald-600 transition-colors text-sm sm:text-base"
//               >
...
//             <div className="w-10 h-10 sm:w-12 sm:h-12 border-4 border-emerald-500 border-t-transparent rounded-full animate-spin mx-auto"></div>
//             <p className="mt-4 text-gray-700 text-sm sm:text-base">Loading announcements...</p>
//           </div>
//         ) : announcements.length === 0 ? (
//           <div className="bg-white rounded-md shadow p-3 sm:p-5 text-center">
//             <p className="text-gray-500 text-sm sm:text-base">No announcements available. Create a new one!</p>
//           </div>
//         ) : (
//           announcements.map(announcement => (
//             <div key={announcement.id} className="bg-white p-3 sm:p-4 md:p-5 rounded-md shadow border border-gray-100 hover:bg-gray-50 transition-colors">
//               <div className="flex justify-between items-start sm:items-center">
//                 <h3 className="text-xs sm:text-sm md:text-base font-medium text-emerald-600">{announcement.title}</h3>
...
//               <div className="mt-1 sm:mt-2 mb-2 sm:mb-3 text-xs sm:text-sm text-gray-500">{announcement.content}</div>
              
//               <div className="flex flex-col sm:flex-row sm:flex-wrap justify-between items-start sm:items-center mt-2 sm:mt-4">
//                 <div className="flex flex-wrap gap-1 sm:gap-2 mb-2 sm:mb-0 w-full sm:w-auto">
//                   <span className={`text-xs px-1.5 sm:px-2 py-0.5 sm:py-1 rounded-full border ${getPriorityColor(announcement.priority)}`}>
//                     {announcement.priority.charAt(0).toUpperCase() + announcement.priority.slice(1)} Priority
//                   </span>
//                   {announcement.userType && (
//                     <span className="text-xs px-1.5 sm:px-2 py-0.5 sm:py-1 rounded-full border bg-emerald-100 text-emerald-800 border-emerald-300">
