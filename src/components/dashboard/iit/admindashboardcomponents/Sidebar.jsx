...
import { FileText, RefreshCcw, Info, Users, ChevronLeft, Menu, X, BellRing } from 'lucide-react';
      ...
      <nav className="p-4 overflow-y-auto" style={{ height: 'calc(100vh - 64px)' }}>
        <ul className="space-y-4">
          ...
          <li>
            ...
            >
              <BellRing className={`w-5 h-5 ${(isOpen || isMobile) ? 'mr-3' : 'mx-auto'}`} />
              {(isOpen || isMobile) && <span>Announcements</span>}
            </button>
          </li>
        </ul>
      </nav>
