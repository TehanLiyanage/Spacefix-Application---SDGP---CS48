...
const items = [
  {
    ...
    description: "Easily book classrooms and study spaces in advance with our intuitive scheduling system for students and Lecturers."
  },
  {
    icon: <OccupancyIcon />,
    title: "Real-Time Space Availability",
    description: "Monitor real-time space availability with occupancy levels, ensuring students find study spaces quickly and efficiently."
  },
  {
    icon: <NavigationIcon />,
    title: "Interactive Campus Navigation",
    description: "Navigate seamlessly through the campus with an interactive mini-map providing real-time directions to lecture halls and study spaces."
  },
  {
    icon: <AlertsIcon />,
  ...
  },
  {
    ...
    description: "Machine learning-driven occupancy detection and incoming crowd analytics to enhance space utilization and prevent overcrowding/underutilized ."
  }
];

const SolutionsSection = () => {
  return (
    <section id="solutions" className="py-20 sm:py-28 bg-gray-50 relative overflow-hidden">
